...
namespace IndicatorBook
{
    public partial class UserForm : Form
    {
        ...
        public UserForm(bool newUser, bool changeUser, bool changeInfo, bool isInit)
        {
            IsInit = isInit;
            ...
            if (NewUser)
            {
                ...
                labelPass1.Text = "کلمه ی عبور :";
                labelPass2.Text = "تایید رمز عبور :";
            ...
            {
                this.Text = "تغییر اطلاعات کاربر";
                labelPass1.Text = "رمز عبور قدیمی :";
                labelPass2.Text = "رمز عبور جدید :";
            }
        }
            ...
            try
            {
                ...
                if (checkBoxForgetPass.Enabled && checkBoxForgetPass.Checked)
                {
                    ...
                    try
                    {
                        ...
                        msg.Subject = "IndicatorBook Password";
                ...
                else if (this.ChangeUser)
                {
                    ...
                    var query = from q in Variables.xDocument.Descendants("User")
                                where textBoxUsername.Text.Trim() == q.Attribute("UserName").Value
                                && textBoxPassword1.Text.Trim() == q.Attribute("Password").Value
                                select q;
                    if (query.Count() == 1)
                    {
